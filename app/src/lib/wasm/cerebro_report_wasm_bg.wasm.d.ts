...
export const reportcompiler_new: (a: number, b: number, c: number, d: number) => [number, number, number];
export const reportcompiler_report: (a: number, b: any) => [number, number, number, number];
export const reportcompiler_pdf: (a: number, b: number, c: number, d: number, e: number) => [number, number, number, number];
export const reportcompiler_svg: (a: number, b: number, c: number, d: number, e: number) => [number, number, number, number];
