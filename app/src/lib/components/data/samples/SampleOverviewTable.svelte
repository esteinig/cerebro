                ...
                <tr class="hover:cursor-pointer" on:click={() => {selectedSampleOverview = sample}}>
                        ...
                        <td>
                            <div class="text-base -mt-1">
                                <a href={`samples/${selectedSampleOverview?.id}/db=${selectedDatabaseId}&project=${selectedProjectId}&workflow=0&db_name=${selectedDatabaseName}&project_name=${selectedProjectName}`} class="btn btn-sm variant-outline-secondary mr-1 opacity-40">
                                ...
                                <a href={`samples/${selectedSampleOverview?.id}/db=${selectedDatabaseId}&project=${selectedProjectId}&workflow=0&db_name=${selectedDatabaseName}&project_name=${selectedProjectName}`} class="btn btn-sm variant-outline-primary">
                                    <div class="w-4 h-4 mr-2">
