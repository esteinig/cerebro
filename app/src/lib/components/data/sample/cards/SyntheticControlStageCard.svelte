<script lang="ts">
	...
	import type { Cerebro, ErccControl, QualityControlSummary } from "$lib/utils/types";
...
<div class="">                
    {#if correlationData.length}
        <p class="text-xs opacity-60 flex justify-start pb-8">
            <span>ERCC</span>
            <span class="ml-5 mr-5">n = {selectedQualityControlSummary.ercc_constructs} / 92</span>
