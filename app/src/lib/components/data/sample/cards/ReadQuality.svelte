<script lang="ts">
    ...
    if (typeof window !== "undefined") {
        ...
        groupColors = {
            ...
            'Duplication': `rgb(${style.getPropertyValue("--color-primary-200").split(" ").join(",")})`,
            'Controls': `rgb(${style.getPropertyValue("--color-primary-300").split(" ").join(",")})`,
            'Reads': `rgb(${style.getPropertyValue("--color-primary-400").split(" ").join(",")})`,
        };
    }
    ...
    <div class="grid grid-cols-2">
        ...
        <div>
            <div class="grid grid-cols-2 sm:grid-cols-2 gap-4 text-small text-center pt-8">
                ...
                <div class="space-y-1">
                    <p class="font-medium opacity-40">Read Quality</p>
                    <p class="text-gray-800 dark:text-gray-100">
        ...
        <div>
            <div class="grid grid-cols-2 sm:grid-cols-2 gap-4 text-medium text-center pt-8">
                ...
                <div class="space-y-1">
                    <p class="font-medium opacity-40">Minimum Length</p>
                    <p class="text-gray-800 dark:text-gray-100">
