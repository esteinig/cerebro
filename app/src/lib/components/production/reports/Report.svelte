<script lang="ts">
    ...
    let pathogenReported: boolean = false;
                ...
                <div class="p-4">
                  ...
                  <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-6 w-3/4 pb-12">
                    ...
                    <div class="flex items-center justify-center">
                        <SlideToggle name="slider-large" bind:checked={reportSchema.patient_result.pathogen_detected} active="bg-primary-500" size="sm"><span class="opacity-60 text-sm">Pathogen detected</span></SlideToggle>
                    </div>
