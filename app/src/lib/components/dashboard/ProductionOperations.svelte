...
<div class="card border p-4 border-primary-500">
    <ListBox class="">
        ...
        <ListBoxItem bind:group={selectedView} name="medium" value="contam", active='variant-soft' rounded='rounded-token'>
            <svelte:fragment slot="lead">
                <div class="w-4 h-4">
        ...
        <ListBoxItem bind:group={selectedView} name="medium" value="assay", active='variant-soft' rounded='rounded-token' on:click={() => goto("./cerebro/training")}>
	        <svelte:fragment slot="lead">
                <div class="w-4 h-4">
