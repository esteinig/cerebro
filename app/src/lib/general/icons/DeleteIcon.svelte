...
<div class="h-{size} w-{size} {divClass}">
    <svg aria-hidden="true" fill="none" stroke="currentColor" class="{iconClass}" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
