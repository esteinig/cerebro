process DiamondNR {
    ...
    --max-target-seqs $params.taxa.assembly.meta.diamond.max_target_seqs--index-chunks $params.taxa.assembly.meta.diamond.index_chunks --block-size  $params.taxa.assembly.meta.diamond.block_size --evalue  $params.taxa.assembly.meta.diamond.min_evalue --id $params.taxa.assembly.meta.diamond.min_identity -o ${id}_ncbi_nr.tsv
