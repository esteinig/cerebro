    ...
    if (fwd_aligned.size() > 0 && rev_aligned.size() > 0) {
        ...
        then
            for seq in sequences/*; do
                ...
                samtools mpileup $params.taxa.assembly.consensus.ivar.mpileup_args -A -B -Q 0 tmp.bam | ivar consensus -p \${seq_name}.consensus -q $params.taxa.assembly.consensus.ivar.min_qual -t $params.taxa.assembly.consensus.ivar.min_freq -m $params.taxa.assembly.consensus.ivar.min_depth -n N
                
                samtools mpileup $params.taxa.assembly.consensus.ivar.mpileup_args -A -B -Q 0 tmp.bam | ivar variants -p \${seq_name}.variants -q $params.taxa.assembly.consensus.ivar.min_qual -t $params.taxa.assembly.consensus.ivar.min_freq -m $params.taxa.assembly.consensus.ivar.min_depth -r \$seq 
