...
process VircovSubsetAlign {
    ...
    """
    vircov --alignment $alignment --fasta $fasta --min-len $params.vircov_min_len --min-cov $params.vircov_min_cov --min-mapq $params.vircov_min_mapq --reads $params.vircov_min_reads --regions $params.vircov_min_regions -v > ${id}_${idx_name}_subset.tsv
