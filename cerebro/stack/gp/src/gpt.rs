    ...
    pub fn tiered() -> Result<Self, GptError> {
        ...
        let check_above_threshold = TreeNode::default()
            ...
            .with_tasks(
                dedent(r"  
                    ...
                    2. Consider the potential for background contamination from reagents, sample site and the environment. Consider making an infectious diagnosis if you are certain the species is a human pathogen. Consider making an infectious diagnosis even if the pathogen is unusual or uncommon for the given sample type and clinical presentation.
        ...
        let check_below_threshold = TreeNode::default()
            ...
            .with_tasks(
                dedent(r"  
                    1. Determine if the metagenomic taxonomic profiling data [Data] supports an infectious diagnosis or a non-infectious diagnosis. Infectious clinical symptoms do not necessarily indicate an infectious cause.
                    2. Consider the potential for background contamination from reagents, sample site and the environment. Consider making an infectious diagnosis if you are certain the species is a human pathogen. Consider making a non-infectious diagnosis if the species is unusual or uncommon for the given sample type and clinical presentation.
                    3. If a virus is detected, strongly consider an infectious diagnosis.
                ")
            )?
            .with_instructions(
