use cerebro_model::api::{
    stage::schema::RegisterStagedSampleSchema, towers::model::ProductionTower,
};
use chrono::Utc;
use mongodb::bson::{doc, to_bson, Document};
use uuid::Uuid;

pub fn create_staged_samples_pipeline(
    schema: &RegisterStagedSampleSchema,
    tower: &ProductionTower,
    team: &str,
    database: &str,
    project: &str,
) -> Vec<Document> {
...
pub fn get_latest_staged_samples_pipeline(
