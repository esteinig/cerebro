...
use crate::taxon::aggregate;
use crate::error::WorkflowError;
use crate::output::WorkflowOutputs;
use crate::filters::TaxonFilterSettings;
use crate::virus::AnnotationOptions;
use crate::taxon::{TaxonomyWarning, Taxon, TaxonEvidence};
use crate::module::{QualityControlModule, KmerModule, AlignmentModule, AssemblyModule};
...
impl WorkflowSample {
    pub fn new(path: &PathBuf, id: &Option<String>, taxonomy: Option<PathBuf>, species_evidence: bool) -> Result<Self, WorkflowError> {
        ...
        let id = match id {
            ...
            None => crate::utils::get_file_stem(&path)?
        };
